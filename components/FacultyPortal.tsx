...
import { Search, Users, ArrowLeft, Clock, MapPin, User, Briefcase, Coffee, Layers, GraduationCap, Calendar } from 'lucide-react';
                ...
                <div className="flex items-center gap-4 w-full">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-3">
                            <h2 className="text-xl md:text-2xl font-bold text-white">{selectedFaculty?.name}</h2>
                        ...
                        <div className="flex items-center gap-3 text-xs text-slate-400 mt-1">
                            <span className="flex items-center gap-1.5 bg-slate-800/50 px-2 py-0.5 rounded-md">
                                <Briefcase size={12} /> {selectedFaculty?.department || 'General Department'}
                            </span>
                        </div>
                    </div>
                </div>
