...
import { University, ArrowLeft, ArrowRight } from 'lucide-react';
...
const PublicHowItWorks: React.FC<PublicHowItWorksProps> = ({ onGoToApp, onGoToHome, onShowAlgorithmDeepDive }) => {
  return (
    <div className="min-h-screen bg-bg text-white font-sans overflow-x-hidden">
      ...
      <header className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:items-center py-4 px-4 sm:px-6 lg:px-8 gap-4 md:gap-0">
        ...
        <nav className="flex items-center gap-2 flex-wrap justify-center">
            <GlassButton onClick={onGoToHome} variant="secondary">Home</GlassButton>
      ...
      <section className="max-w-7xl mx-auto mt-24 sm:mt-32 px-4 sm:px-6 lg:px-8">
        <GlassPanel className="p-8 md:p-12 text-center">
             <h3 className="text-3xl font-bold text-white">Ready to Revolutionize Your Scheduling?</h3>
