...
export const PublicPageLayout: React.FC<PublicPageLayoutProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text-white)] font-sans overflow-x-hidden">
      <div className="absolute top-0 left-0 w-full h-[600px] bg-gradient-to-br from-accent/10 via-bg to-bg -z-10" />

      <header className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:items-center py-4 px-4 sm:px-6 lg:px-8 gap-4 md:gap-0 sticky top-0 z-50 bg-[var(--bg)]/80 backdrop-blur-md">
